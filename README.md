...
- `dashboard/hospital_review.py`: local assisted manual review helper.
- `src/data/`: data download, cleaning, merge, registry correction, and layer-building scripts.
- `src/models/forecast_city_pressure.py`: forecast generation.
- `src/features/pressure_index.py`: HPI scoring logic.
- `tests/test_pressure_index.py`: pressure-index unit tests.

## Static Visual Assets

README images are stored in `static/`:

- `static/Screenshot 2026-06-03 at 20-15-08 Hospital Pressure Index - Ruhrgebiet.png`
- `static/Screenshot 2026-06-03 at 20-15-50 Hospital Pressure Index - Ruhrgebiet.png`
- `static/Screenshot 2026-06-03 at 20-16-54 Hospital Pressure Index - Ruhrgebiet.png`
- `static/Screenshot 2026-06-03 at 20-19-36 Hospital Pressure Index - Ruhrgebiet.png`
- `static/Screenshot 2026-06-03 at 20-21-26 Hospital Pressure Index - Ruhrgebiet.png`
